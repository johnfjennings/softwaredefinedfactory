...
{/* hero-image-prompt: photorealistic sweeping panorama of an Industry 4.0 factory, robotic cells conveyors and AGVs coordinated under real-time production displays, workers supervising with tablets, bright clean architecture with blue accent lighting, ultra wide, editorial industrial technology photography, cinematic lighting, high detail, no text, no watermark */}
