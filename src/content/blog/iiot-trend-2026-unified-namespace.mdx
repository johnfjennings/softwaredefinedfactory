...
coverImage: "/images/blog/unified-namespace-mqtt.jpg"
draft: true
---

{/* hero-image-prompt: photorealistic dark operations wall displaying a unified namespace topology, hierarchical tree of factory sites lines and machines converging into one glowing central data broker node, MQTT message streams as light trails, teal and blue palette, editorial industrial technology photography, cinematic lighting, high detail, no text, no watermark */}
