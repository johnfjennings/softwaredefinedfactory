...
{/* hero-image-prompt: photorealistic production supervisor at a factory floor andon board showing OEE gauges for availability performance and quality with a large overall percentage, real production line softly blurred behind, clean data visualization, editorial industrial technology photography, cinematic lighting, high detail, no text, no watermark */}
