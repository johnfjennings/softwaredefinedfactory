...
{/* hero-image-prompt: photorealistic industrial control room, factory operator reviewing an AI agent's proposed work order on a large monitor showing a multi-step decision workflow, robotic arms and conveyor visible through window in background, cool blue and amber accent lighting, editorial technology photography, dark moody atmosphere */}
