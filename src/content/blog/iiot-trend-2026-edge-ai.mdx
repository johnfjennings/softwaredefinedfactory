...
{/* hero-image-prompt: photorealistic industrial edge computing AI gateway device mounted on factory wall with glowing blue LED status indicators, neural network hologram floating above industrial machines, blurred robotic assembly line background, dramatic directional lighting, ultra wide angle, editorial technology photography, dark moody atmosphere */}
